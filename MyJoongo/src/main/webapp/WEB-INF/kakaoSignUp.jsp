...
<link href="/joongo/css/kakaoSignUp.css" rel="stylesheet" type="text/css">
<title></title>
<script src="https://ajax.aspnetcdn.com/ajax/jQuery/jquery-3.3.1.min.js"></script>
<script src="/joongo/script/kakaoSignUp.js" type="text/javascript"></script>
</head>
<body>
	<div class="middle">
		<div class="signup_container">
			...
			<form id="form" method="post" action="register.do" onsubmit="return false">
				<div class="signup">
					...
					<span class="box"> <input type="text" name="name" id="name" value="${name }">
					</span>
					<p id="name_msg"></p>
				</div>
				<div class="signup">
					<h4 class="signup_title">아이디</h4>
					<span class="box"> <input type="text" name="loginId" id="id" value="${loginId }" readonly>
				...
				<div class="signup">
					...
					<span class="box"> <input type="password" name="password" id="pw" value="${loginId }" readonly>
					</span>
					<p id="pw_msg"></p>
				</div>
				<div class="signup">
				...
				<div class="signup">
					...
					<span class="box"> <input type="text" name="phone1" id="phone1" class="phone" maxlength="3" pattern="[0-1]{3}" value="010"> <input type="text" name="phone2" id="phone2" class="phone" maxlength="4" pattern="[0-9]{4}"> <input type="text" name="phone3" id="phone3" class="phone" maxlength="4" pattern="[0-9]{4}"> <input type="hidden" id="phone" name="phone">
				...
				<div class="signup">
					...
					<span class="box"> <input type="text" name="email" id="email" value="${email }" readonly>
					</span>
					<p id="email_msg"></p>
				</div>
				<div class="signup">
